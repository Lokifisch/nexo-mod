package dev.nexoclient.nexomod.tactical.chunks;
...
import dev.nexoclient.nexomod.tactical.nativecore.NexoNativeChunks;
...
public final class NexoChunkHistory {
	...
	/** Registered from {@code NexoTacticalFeatures}; a no-op at runtime when the store is unavailable. */
