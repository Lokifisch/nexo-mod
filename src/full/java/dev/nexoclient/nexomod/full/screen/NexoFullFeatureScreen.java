 ...
 */
public class NexoFullFeatureScreen extends NexoOptionScreen {
	/**
	...
	public NexoFullFeatureScreen(Screen lastScreen) {
		super(lastScreen, Component.translatable("nexomod.settings.full.title"),
				new NexoSettingsOptionList(NexoFullFeatureScreen::addRows));
	}
	...
	private static void addEnvironmentRows(NexoSettingsOptionList list, NexoConfig config) {
		list.addWidgetRow(CycleButton.<TimeOverride>builder(NexoFullFeatureScreen::timeLabel, config.timeOverride())
		...
		list.addWidgetRow(CycleButton.<WeatherOverride>builder(NexoFullFeatureScreen::weatherLabel, config.weatherOverride())
