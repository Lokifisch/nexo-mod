package dev.nexoclient.nexomod.full;
...
import dev.nexoclient.nexomod.full.chunks.NexoChunkHistory;
import dev.nexoclient.nexomod.full.ghost.NexoGhostMode;
import dev.nexoclient.nexomod.full.hud.NexoArmorHud;
import dev.nexoclient.nexomod.full.macro.NexoMacroTriggers;
import dev.nexoclient.nexomod.full.screen.NexoBedrockHoleScreen;
import dev.nexoclient.nexomod.full.screen.NexoFullFeatureScreen;
import dev.nexoclient.nexomod.full.tactical.NexoSoundRadar;
import dev.nexoclient.nexomod.full.tactical.NexoSoundRadarHud;
 ...
 *
 * <p>{@code nexomod-light} is the variant a server admin can whitelist without
 ...
 *
 * <ol>
 * <li>A new full-only feature goes under {@code dev.nexoclient.nexomod.full.*}
 ...
 * <li>A mixin for it goes in {@code dev.nexoclient.nexomod.full.mixin} and is
 *     listed in {@code nexomod-full.mixins.json}, never in
 ...
 * </ol>
 */
public class NexoFullFeatures implements ClientModInitializer {
	@Override
	public void onInitializeClient() {
		...
		NexoExtraCategories.register(Component.translatable("nexomod.settings.full"), NexoFullFeatureScreen::new);
	}
}
